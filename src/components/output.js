  ...
  render() {
    ...
    return (
      <div className="output">
        ...
        <h3>{weight} lbs</h3>
        <h3>BMI: {bmi}</h3>
        <h3 className={(this.props.data.bmiClass === "Obese") ? "danger" : ""}>{bmiClass} {(this.props.data.bmiClass === "Obese") ? <a href='http://www.health.com/health/gallery/0,,20501331,00.html' target="_blank">What can I do?</a> : ""}</h3>
      </div>
    );
  }
}
